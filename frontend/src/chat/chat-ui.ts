...
export class ChatUI {
   ...
   */
  setChatTitle(title: string, targetUserId?: number, roomType?: 'public' | 'private' | 'protected', roomOwnerId?: number, currentUserId?: number, avatarUrl?: string, isBlocked?: boolean): void {
